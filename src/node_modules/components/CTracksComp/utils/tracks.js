...
function horizontalBedlikeOptions (overrides, primaryColor) {
  return Object.assign(
    horizontalOptions(),
    {
      fillColor: primaryColor || "red"
    },
    overrides
  )
}
...
function track (overrides, options, primaryColor) {
  let track = {
    name: "",
  ...
  if (overrides.datatype === 'bedlike') {
    track = Object.assign(track, {type: "bedlike"})
    options = horizontalBedlikeOptions(options, primaryColor)
  } else {
    track = Object.assign(track, {type: "horizontal-point", datatype: "vector"})
    options = horizontalPointOptions(options, primaryColor)
  }
...
function merge(target, ...sources) {
  return _.mergeWith(target, ...sources, (objValue, srcValue, key, object) => {
    if (key === 'constIndicators') {
      return srcValue
...
export default {
  options: {
    ...
    'bedlike': horizontalBedlikeOptions
  },
  getPrimaryColor,
  track,
  merge,
