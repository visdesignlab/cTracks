...
class TracksMenu extends React.Component {
  ...
  typeChange = (item) => {
    this.setTrackValue('type', item.value)
  }
    ...
    switch (type) {
      ...
      case 'range':
        return (
          <div>
            <div className="ColorPicker">
              <CompactPicker color={this.state.editTrack.options.minMaxColor} onChange={color => this.setOptionValue('minMaxColor', color.hex)}/>
            </div>
            <div>
