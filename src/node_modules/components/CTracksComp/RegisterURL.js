...
class RegisterURL extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      tilesets: [],
      coordSystem: {value: null, label:'', server: {}, tileset: {}},
      error: null
    }
  }
  ...
  serverElement = (server, order) => {
    ...
    if (this.state.server.value !== null && this.state.url !== '') {
      hamradio.publish('url/register', {
        ...
        coordSystem: this.state.coordSystem.value
      }).then(() => {
        this.setState({
          url: '',
          name: '',
      ...
      <div>
        ...
        <LabelLayout label="Registry Server"
          inner=<Selector
            ...
            onChange={val => this.setState({server: val, coordSystem: {value: null, label:'', server: {}, tileset: {}}})}
          />
        />
        ...
        <LabelLayout label="Chromosome Sizes"
          inner=<Selector
            ...
            options={this.state.tilesets.filter(tileset => tileset.server.api === this.state.server.api)}
