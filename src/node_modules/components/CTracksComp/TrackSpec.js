...
class TrackSpec extends React.Component {
  ...
  pointColorChange = (color) => {
	...
	render () {
      ...
      <div>
        <ul>
          <li>{this.props.track.track.server}</li>
          <li>{this.props.track.track.name}</li>
        </ul>
        ...
        <br/>
        <button type="button" className="btn btn-default Button" onClick={this.props.done}>Done</button>
      </div>
		)
	}
}
