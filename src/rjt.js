	...
	renderRows: function( cols ){
		...
		var rows = items.map( function( item ){
			...
			return React.createElement(Row, {
				...
				onRowEnter: me.onRowEnter,
				onRowLeave: me.onRowLeave,
...
var Row = React.createClass({
	...
	render: function() {
      ...
      onMouseEnter: me.onRowEnter,
      onMouseLeave: me.onRowLeave,
	...
	onRowEnter: function( e ){
		this.props.onRowEnter( e, this.props.item );
	},

	onRowLeave: function( e ){
		this.props.onRowLeave( e, this.props.item );
	}
});
