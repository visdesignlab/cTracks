...
class CTracksComp extends React.Component {
  ...
  GenerateHiglassView(ConfigFile) {
    ...
    var HiglassViewConfig = new GenerateViewConfig(ConfigFile, this.highlightRegion);
  ...
  RetrieveViewID() {
    ...
    HiglassAPI.fetchViewConfig().then(function (ViewUID) {
  ...
  RetrieveLocation_Static() {
    ...
    HiglassAPI.fetchLocation().then(function (location) {
  ...
  handleRowEnter(row) {
    ...
    const rowStart = this.chromInfo.chrPositions[row['#chrom']].pos + +row.start;

    const rowEnd = this.chromInfo.chrPositions[row['#chrom']].pos + +row.stop;
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          'div',
          { className: 'Box' },
          this.state.InputConfigFile ? React.createElement(TracksMenu, { ConfigFile: this.state.InputConfigFile, UpdateDisplay: this.GenerateHiglassView
          }) : null
        ),
        React.createElement(
          'div',
          ...
          React.createElement(ChromView, null)
        ),
        React.createElement(
          'div',
          { className: 'Box' },
          ...
          this.state.InputConfigFile && this.state.CNVSelection ? React.createElement(NGSLink, {
      ...
      React.createElement(
        ...
        React.createElement(
          'div',
          { className: 'RightBox' },
          this.state.HiglassView ? React.createElement(HiglassUI, {
        ...
        React.createElement(
          'div',
          { className: 'RightBox' },
          this.state.APIInfo && this.state.CNVData && React.createElement(CNVTable, {
